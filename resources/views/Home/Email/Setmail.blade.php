                                            ...
                                            <tbody>
                                                <tr style="font-weight:300">
                                                    ...
                                                    <td style="max-width:480px;text-align:left;">
                                                        <h1 id="cTMail-title" style="font-weight:bold;font-size:20px; line-height:36px; margin:0 0 16px;">找回密码</h1>
                                                        <p id="cTMail-userName" style="font-size:14px;color:#333; line-height:24px; margin:0;">尊敬的严选用户，您好！</p>
                                                        <p class="cTMail-content" style="font-size:14px;color:#333; line-height:24px; margin:6px 0 0 0;word-wrap:break-word; word-break:break-all;">您要找回密码，IP为：{{ $Get_ip }}</p>
                                                        <a href="{{ $systems['system_site_url'] }}/User/mail/email/?id={{ $uid }}&token={{ $u_token }}" targer="_blank" id="cTMail-btn" style="font-size:16px; line-height:45px;  display:block; background-color:#00a4ff; color:#fff; text-align:center; text-decoration:none;margin-top:28px;margin-bottom:36px;border-radius:3px;">点击验证</a>
